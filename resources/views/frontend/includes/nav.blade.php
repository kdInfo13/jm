...
<!--<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  <div class="container">
    <a class="navbar-brand" href="#">
        <img width="148" height="30" src="https://livedemo00.template-help.com/wt_60075_v2/images/logo-light-148x30.png" alt="">
    </a>
...
<!-- main-menu Start -->
		<header class="top-area">
			<div id="sticky-wrapper" class="sticky-wrapper" style="height: 78px;"><div class="header-area" style="width: 1518px;">
				<div class="container">
					<div class="row">
						<div class="col-sm-2">
							<div class="logo">
